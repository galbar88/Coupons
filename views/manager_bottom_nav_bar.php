  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">';
        ...
        echo '<li '; if ($section === "bussinesses") echo 'class="active"';
		echo '><a href="manager-index.php?section=bussinesses">My Bussinesses</a></li>';
		
		echo '<li '; if ($section === "coupons") echo 'class="active"';
		echo '><a href="manager-index.php?section=coupons">My Coupons</a></li>';
    
    echo '<li><a href="index.php">Shop at Coupons</a></li>';
